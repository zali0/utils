...
for (var i = 0; i < stores.length; ++i) {
    ...
    for (var x = 0; x < 1; ++x) {
        ...
        var generateNewTimeInterval = function () {
        };
        var referenceTime = enterTime;
        var keeperPresence = true;
        var gaps = getRandomInt(4, 6);
        for (var z = 8; z <= 24; ++z) {
            // enterTime to some time.
            console.log("I AM HERE");
            var hour = referenceTime.getHours();
            var minutes = referenceTime.getMinutes();
